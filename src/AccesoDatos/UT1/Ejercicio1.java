...
//Crear un archivo de texto y escribir tu nombre, edad y curso.
//Leer el archivo línea a línea y mostrar su contenido en consola.
//Añadir más líneas al final sin borrar lo anterior.
//Copiar el contenido de un archivo a otro con BufferedReader y BufferedWriter.
...
public class Ejercicio1 {
    ...
    private static void anadirLineas() {
        ...
        try {
            bw = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(ARCHIVO.toFile(), true)));
